...
// first will query using the provided gorm.DB and it will get the fiest item returned and palce it into dst.
// If nogthing is fount in the query, it will return ErrNotFount
...
// ByEmail looks up a user with the given email adress and return that user.
// If the user is found, we will return a nil error
// If the user is not found, we will retorun ErrNotFound
// If there is another error, we will return an error with more information abuot what went wrong.
